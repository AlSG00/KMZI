...
namespace KMZI
{
    public partial class Freq : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < alphabet_sorted.Length; i++)
            {
                //textBox2.Text = textBox2.Text.Replace(alphabet_sample[i], alphabet_sorted[i]);
                textBox2.Text = textBox2.Text.Replace(alphabet_sorted[i], alphabet_sample[i]);
